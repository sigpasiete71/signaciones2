...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            if (rtrim($pathinfo, '/') === '/user/create') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'emm_user_redirect_add');
                }

                return array (  '_controller' => 'EMM\\UserBundle\\Controller\\UserController::addAction',  'path' => '/user/add',  'permanent' => true,  '_route' => 'emm_user_redirect_add',);
            }

            // emm_user_redirect_edit
            if (0 === strpos($pathinfo, '/user/update') && preg_match('#^/user/update/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'emm_user_redirect_edit')), array (  '_controller' => 'EMM\\UserBundle\\Controller\\UserController::editAction',  'path' => '/user/edit/{id}',  'permanent' => true,));
            }
